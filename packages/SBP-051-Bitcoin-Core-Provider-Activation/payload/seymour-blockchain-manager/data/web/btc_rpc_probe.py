...
RPC_URL = os.environ.get(
    "BTC_RPC_URL",
    "http://seymour-bitcoin-node_node_1:8332/",
)
...
RPC_TIMEOUT_SECONDS = max(
    ...
    int(
        os.environ.get(
            "BTC_RPC_TIMEOUT_SECONDS",
            "20",
        )
    ),
)

BTC_NODE_CONTAINER = os.environ.get(
    "BTC_NODE_CONTAINER",
    "seymour-bitcoin-node_node_1",
)
...
def probe() -> dict[str, Any]:
    ...
    # it can be slow while Bitcoin Core is in initial block download.
    ...
    # Bitcoin Core can take a long time to answer getblockchaininfo
